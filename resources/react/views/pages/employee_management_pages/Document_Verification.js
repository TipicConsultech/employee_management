...
// import { useTranslation } from 'react-i18next';
// import CIcon from '@coreui/icons-react';
// import { cilTrash, cilZoom, cilCloudUpload, cilPlus } from '@coreui/icons';
...
//         setDocumentUploads(documentUploads.filter(doc => doc.id !== id));
//     };
...
//         const invalidDocs = documentUploads.filter(doc => !doc.documentType || !doc.file);
//         if (invalidDocs.length > 0) {
//             showNotification('warning', 'Please complete all document fields');
//             return;
//         }
...
//                                                             <small>Click "Add Document" to start uploading</small>
//                                                         </div>
//                                                     </CTableDataCell>
//                                                 </CTableRow>
//                                             )}
